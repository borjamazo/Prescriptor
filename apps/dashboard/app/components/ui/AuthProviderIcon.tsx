...
export function AuthProviderIcon({ provider, className }: AuthProviderIconProps) {
  ...
  if (provider === "google") {
    return (
      <svg className={base} viewBox="0 0 24 24" aria-label="Google">
        <path
  ...
  if (provider === "facebook") {
    return (
      <svg className={base} viewBox="0 0 24 24" aria-label="Facebook">
        <path
          fill="#1877F2"
  ...
  if (provider === "linkedin") {
    return (
      <svg className={base} viewBox="0 0 24 24" aria-label="LinkedIn">
        <path
          fill="#0A66C2"
  ...
  return (
    <svg
      className={cn(base, "text-surface-400")}
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth={2}
